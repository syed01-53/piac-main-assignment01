"use strict";
//Personal Message:
var message = "Hello  ! zain Sultan would you like to learn some Python today";
console.log(message);
//Name Cases 
//lowercase
var nameInfo = "ZAIN SULTAN ";
console.log(nameInfo.toLocaleLowerCase());
//to uppercase 
var nameInfo = "ali sultan ";
...
//Famous Quote 2:
var famousPerson = "Nelson Mandela ::";
var famousQuotes = "  “The greatest glory in living lie never in the falling but in rising in every time we fall.” ";
var FamousQuote2 = famousPerson.concat(famousQuotes);
...
//Names:11
let MyFriends = ['ali', 'ahmad', "Hmmadula", "mehmmad "];
// comment :10
...
//  Your Own Array:
let favorite = ["The Honda C70 typically features a small, efficient, and reliable 72cc, four-stroke, single-cylinder engine.", "The C70 is known for its simple and timeless design, often referred to as a", "step-through design, which makes it easy for riders to get on and off the bike.", " It usually comes with a semi-automatic transmission, often referred to as a clutchless or semi-auto transmission. "];
for (const iterator of favorite) {
    console.log(iterator);
}
// invited person 
let personInvited = ["zain", "Ali", "Mehmmad"];
